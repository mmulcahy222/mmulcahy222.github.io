  ...
  getUniformFromNode(node, type, shaderStage, name = null) {
    ...
    if (uniformGPU === void 0) {
      ...
      if (type === "texture") {
        ...
        const buffer = new NodeUniformBuffer_default(node, group);
...
export {
  GLSLNodeBuilder_default as default
};
//# sourceMappingURL=three_src_renderers_webgl-fallback_nodes_GLSLNodeBuilder__js.js.map
