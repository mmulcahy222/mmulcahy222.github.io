...
var StructType_default = StructType;
...
var NodeBuilder = class {
  ...
  getBindGroupsCache() {
    ...
    if (bindGroupsCache === void 0) {
      bindGroupsCache = new ChainMap_default();
  ...
  getStructTypeFromNode(node, membersLayout, name = null, shaderStage = this.shaderStage) {
    ...
    if (structType === void 0) {
      ...
      structType = new StructType_default(name, membersLayout);
  ...
  getVarFromNode(node, name = null, type = node.getNodeType(this), shaderStage = this.shaderStage, readOnly = false) {
    ...
    if (nodeVar === void 0) {
      ...
      nodeVar = new NodeVar_default(name, type, readOnly, count);
      if (!readOnly) {
        vars.push(nodeVar);
      }
...
//# sourceMappingURL=chunk-LVVPSY3O.js.map
